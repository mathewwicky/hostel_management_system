...
function Footer() {
  return (
    <div>
        <footer className="bg-black rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
    <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0 ml-4" >
        &copy; 2023 <a href="#" className="hover:underline ml-2" target="_blank" rel="noopener noreferrer">CodeSynergy.com</a>. All rights reserved.
    </p>
    <div className="flex justify-center items-center space-x-1 mr-12">
